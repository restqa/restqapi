...
describe("#StepDefinition - then - functions", () => {
  ...
  describe("API Default Functions", () => {
    test("httpCode", () => {
      ...
      expect(assert.strictEqual.mock.calls[0][2]).toBe(
    ...
    test("httpTiming - When timing is higher", () => {
      ...
      expect(assert.ok.mock.calls[0][1]).toBe(
  ...
  describe("API Headers Functions", () => {
    test("headerValueExist", () => {
      ...
      expect(assert.notStrictEqual.mock.calls[0][2]).toBe(
    ...
    test("headerValueNotExist", () => {
      ...
      expect(assert.strictEqual.mock.calls[0][2]).toBe(
        "[POST /users] The response header should not contain the x-req-id property"
      )
    })
  ...
  describe("API Body Functions", () => {
    ...
    test("shouldBeEmptyResponse", () => {
      ...
      expect(assert.strictEqual.mock.calls[0][1]).toBeUndefined()
      expect(assert.strictEqual.mock.calls[0][2]).toBe(
        "[POST /users] The response body should be empty"
      )
    })
    ...
    test("shouldBeNumber", () => {
      ...
      expect(assert.strictEqual.mock.calls[0][2]).toBe(
        "[POST /users] The response body property foo should be 456 but received 123"
      )
    })
    ...
    describe("shouldMatch", () => {
      test("shouldMatch with a regex format like \\d(.*)", () => {
        ...
        expect(assert.ok.mock.calls[1][1]).toBe(
          "[POST /users] The response body property foo.bar should match the regexp ^my value$ but received : my value"
        )
      })
